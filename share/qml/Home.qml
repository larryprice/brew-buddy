...
Page {
    ...
    header: PageHeader {
        ...
        trailingActionBar.actions: [
            Action {
                iconName: "add"
                onTriggered: pageStack.addPageToCurrentColumn(home, Qt.resolvedUrl("RecipeOverview.qml"))
            }
        ]
    }
    ...
    Column {
        ...
        Button {
            ...
            onClicked: {
                pageStack.addPageToCurrentColumn(home, Qt.resolvedUrl("RecipeOverview.qml"))
            }
